...
타입의 유효성은 C# 컴파일러의 변환 규칙에 따라 검사합니다. 따라서 상속과 인터페이스 구현뿐 아니라 숫자 변환, 박싱과 언박싱, 명시적 참조 변환, 사용자 정의 변환도 사용할 수 있습니다.

- 필드 타입에서 프로퍼티 타입으로 변환할 수 있어야 합니다.
- 암시적 변환이 아닌 경우 생성된 접근자에 명시적 캐스트를 추가합니다.
